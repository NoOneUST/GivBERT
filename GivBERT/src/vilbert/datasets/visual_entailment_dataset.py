...
class VisualEntailmentDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # image = jpeg.JPEG(self.dataroot+'flickr30k_images/'+str(image_id)+'.jpg').decode()
        image = Image.open('/dev/shm/COMP5212/'+self.dataroot+'flickr30k_images/'+str(image_id)+'.jpg')
